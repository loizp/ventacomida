...
public class VentanaPrincipalController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        Image image = new Image(getClass().getResourceAsStream("assets/home.png"));
    ...
    private void OnClicRegistrar(ActionEvent event) {
        try {
            ...
            for (CellTableProducto item : tableview.getItems()) {
                cantidad = Integer.parseInt(item.cantidad);
    ...
    public class PedidoCell extends ListCell<Pedido> {
        ...
        ImageView imgpedido = new ImageView(new Image(getClass().getResourceAsStream("assets/list.png"), 44, 44, false, false));
